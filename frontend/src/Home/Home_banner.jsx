...
const Home_banner = ({ pixelatedOfManish }) => {
  return (
    <>
      <HomeBannerClient>
          ...
          <div className="flex relative mx-auto flex-col  md:flex-row">
            ...
            <div className="md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1">
              ...
              <h3 data-aos="zoom-in-up" data-aos-duration="700" data-aos-offset="-20" className="text-sm md:text-md text-justify">
                I channel my passion and curiosity into impactful projects that bridge education, technology, and social action. Whether as a student, web developer, social activist, or photographer, I am committed to exploring new avenues for
                creating positive change and contributing to the welfare of society.{" "}
              </h3>
              <br />
              {/* social media icon */}
