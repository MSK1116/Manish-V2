        ...
        <div className=" relative md:h-screen h-[80vh] w-full  overflow-hidden">
                      ...
                      {imageList.map((testimonial, index) => (
                        <motion.div
                          ...
                          <div onClick={() => handleImageClick(index)} className="relative h-full  w-full  cursor-pointer">
                            <Image className=" object-cover size-full md:rounded-3xl rounded-xl" fill={true} draggable={true} src={`/studio/${testimonial.link_low}`} alt={testimonial.description}></Image>
                          </div>
                        </motion.div>
                      ))}
                    </AnimatePresence>
          ...
          <AnimatePresence className={"relative"} mode="wait">
            <motion.div
              ...
              <Image className="size-full object-cover" src={`/studio/${imageList[click].link}`} alt={imageList[click].title} fill={true}></Image>
